...
def unpadding(text):
    ...
    Returns:
        str or bytes: 去除padding后的数据
    """
    return text[:-text[-1]]


def bytes_to_list(input_bytes, block_len):
    """将字节串切分成指定长度的子串
